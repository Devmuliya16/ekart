...
<form class="w-1/2 m-auto mt-16" action="./user-signup" method="post">
<span class="text-[50px]"><img src="product-image/shopify.png" class="h-8 mr-3 rounded-full bg-white inline-block" alt="Flowbite Logo" />Shopify</span>
	<div class="text-[30px]">Signup</div>
  <div class="mb-6 ">
    <label for="name" class="block mb-2 text-sm font-medium text-gray-900 ">Your name</label>
    <input type="text" name="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="user name" required>
  </div>
  <div class="mb-6 ">
